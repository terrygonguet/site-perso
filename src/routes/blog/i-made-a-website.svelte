<script>
	...
	export const tags = ["first","cv","svelte","project","development"]
...
<svelte:head>
	<title>Terry Gonguet - Blog - I made a new website for myself</title>
</svelte:head>
