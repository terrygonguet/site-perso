<script>
	...
	export const tags = ["studies","ireland","school"]
	
	export let translations = {"français":"2-ans-en-irlande"}

	const dev = process.env.NODE_ENV == "development"
</script>

<svelte:head>
	<title>Terry Gonguet - Blog - 2 years in Ireland</title>
</svelte:head>
...
<main
	...
	<article class="m-4 max-w-1k max-h-full text-justify">
		<h1 class="text-4xl">2 years in Ireland</h1>
