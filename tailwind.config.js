		...
		plugin(function({ addUtilities, addComponents, addBase, theme }) {
			...
			addBase({
				":root": {
					...
					"--color-radial-bg-dark": "#333333",
					"--color-radial-outline": "#777777",
					"--color-radial-center": "black",
					"--color-radial-accent": "var(--color-accent-light)"
				}
			})
			...
			addComponents({
				".a": {
					...
					[`&[target="_blank"]::after`]: {
						backgroundImage: `url("svg/external-link.svg")`,
						width: "0.8em",
						height: "0.8em",
